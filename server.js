...
const data = {
  ...
  "detail_screen_smartphone": {
    "data": {
      detailSmartphone:  {
    "data": detailSmartphone
    } 
    }
  },
  "detail_screen_tablet": {
    "data": {
      detailTablet:  {
    "data": detailTablet
    } 
   ...
   "detail_screen_lipstick": {
    ...
    "detail_screen_moisturizer": {
    "data": {
      detailMoisturizer:  {
    "data": detailMoisturizer
    } 
    }
  },
     "detail_screen_shampoo": {
    "data": {
      detailShampoo:  {
    "data": detailShampoo
    } 
   ...
   "detail_screen_freshvegetables": {
    "data": {
      detailFreshVegetables:  {
    "data": detailFreshVegetables
    } 
    }
  },
  "master_screen_electronics": {
    "data": {
      electronicsCategoryView:  {
    "data": electronicsCategoryView
  } ,
      electronicsListView: {
    "data": electronicsListView
  }
    }
  },
  "master_screen_electronics": {
  ...
  "master_screen_beauty": {
    "data": {
     beautyCategoryView: {
    "data": beautyCategoryView
  } ,
      beautyListView: {
        "data":beautyListView
      }
  ...
  "home_screen": {
    "data": {
      "carousel1": {
        "data": [
          {
            "url": "https://i.pinimg.com/736x/51/d3/88/51d38806d50482762c700eca5717a32f.jpg",
      ...
      "carousel2": {
        "data": [
          ...
          {
            "url": "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/89741ecb1291788f128600a5da5f18b4",
            "discount": "20"
          },
          {
            "url": "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/ee4f041cd8611dccc19f4267783ab5ea",
            "discount": "40"
          }
        ]
      }
